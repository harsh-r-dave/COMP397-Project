...
var scenes;
(function (scenes) {
    var LevelOneLose = (function (_super) {
        __extends(LevelOneLose, _super);
        ...
        // CONSTRUCTOR ++++++++++++++++++++++
        function LevelOneLose() {
            _super.call(this);
        }
        // PUBLIC METHODS ++++++++++++++++++++
        // Start Method
        LevelOneLose.prototype.start = function () {
            //Add Menu Label
            ...
            //Add SCORE Label
            this._scoreLabel = new objects.Label("Collected: " + scoreboard.getLevelOneTarget() + "/2500Ltr\nSorry you lost!! \nNo worries, Try again!!", "25px Frijole", "#ffff00", config.Screen.CENTER_X, 100, true);
        ...
        LevelOneLose.prototype.update = function () {
        ...
        LevelOneLose.prototype._playAgainButtonClick = function (event) {
            // Switch to the PLAY Scene
            scene = config.Scene.LEVELONE;
            changeScene();
        };
        // HOME Button click event handler
        LevelOneLose.prototype._homeButtonClick = function (event) {
    ...
    scenes.LevelOneLose = LevelOneLose;
})(scenes || (scenes = {}));
//# sourceMappingURL=levelonelose.js.map