/*
    ...
    Program Description: Level three lose scene
...
var scenes;
(function (scenes) {
    var LevelTwoLose = (function (_super) {
        __extends(LevelTwoLose, _super);
        //private _player3:createjs.Bitmap;
        //private _obstacles: objects.Obstacles[];
        //private _obstaclesCollection: string[];
        // CONSTRUCTOR ++++++++++++++++++++++
        function LevelTwoLose() {
            _super.call(this);
        }
        // PUBLIC METHODS ++++++++++++++++++++
        // Start Method
        LevelTwoLose.prototype.start = function () {
            //Add Menu Label
            ...
            this._background = new objects.Sea();
        ...
        LevelTwoLose.prototype.update = function () {
        ...
        LevelTwoLose.prototype._playAgainButtonClick = function (event) {
            // Switch to the PLAY Scene
            scene = config.Scene.LEVELTWO;
            changeScene();
        };
        // HOME Button click event handler
        LevelTwoLose.prototype._homeButtonClick = function (event) {
    ...
    scenes.LevelTwoLose = LevelTwoLose;
})(scenes || (scenes = {}));
//# sourceMappingURL=leveltwolose.js.map